    ...
    <div class="header-2">
        ...
        *{
        ...
        body{
            ...
            background-image: url(image/sellerlogin.png);
...
<!--header section end-->
    ...
    <div class = "formbox">
	<h3 style = "text-align:center"><font size = "6">Seller Login</h3></font><br>

   <form action = "log" method = "post">
   <center><h2>
    E-mail : <br> <input type = "text" name = "emailF" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required> <br><br>
    Password : <br> <input type = "Password" name = "passwordF"> <br><br>
   </center>
    ...
    <button type = "Submit" class = "Submit-button">Log in</button>
      ...
      <center><p class = "p-1">Have you not registered? <a href="index.jsp">Register from here</a></p></center>  
