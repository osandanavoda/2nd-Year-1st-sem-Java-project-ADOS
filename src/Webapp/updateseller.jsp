    ...
    <div class="header-2">
        ...
        *{
        ...
        body{
            ...
            background-image: url(image/selleracc2.jpg);
...
<div class = "formbox">
	<h3 style = "text-align:center"><font size = "6">Update Seller</h3></font><br>

	<form action="update" method = "post">
	<h2>
		Seller ID : <br><input type="text" name = "selid" value ="<%= sellerID %>" readonly><br><br>
		First Name : <br><input type="text" name = "fname" value ="<%= firstName %>"><br><br>
		Last Name : <br><input type="text" name = "lname" value ="<%= lastName %>"><br><br>
		Email : <br><input type="text" name = "email" value ="<%= email %>"><br><br>
		Password : <br><input type="password" name = "passw" value ="<%= password %>"><br><br>
		Confirm Password : <br><input type="password" name = "cpassw" value ="<%= confirmPassword %>"><br><br>
		Contact Number :  <br><input type="text" name = "contactno" value ="<%= contactNumber %>"><br><br>
